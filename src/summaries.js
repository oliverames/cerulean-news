...
export const INCLUSION_PRIORITIES = "They monitor news in priority order: (1) anything mentioning BCBSVT/Blue Cross, including the Blue Cross Blue Shield Association (BCBSVT is a member) and other Blue plans, (2) Vermont health care broadly — hospitals, regulators, legislature, coverage, public health, even small local items that involve a Vermont or Vermont-serving provider, (3) New England health care, (4) national health news whose outcome reaches a Vermont health insurer: federal health policy and programs (ACA, Medicare, Medicare Advantage, Medicaid), the insurance/payer industry and PBMs, drugs, vaccines, and FDA decisions, CDC and other national public-health data, health costs and affordability, and health politics and polling. A single state's own program, market, lawsuit, or employer outside New England is not national.";
export const INCLUSION_RULES = "Geography matters: a Vermont story involving hospital operations, providers, coverage, regulators, access, public health, or costs is relevant. Crime, crash, and accident briefs are not relevant just because someone was taken, sent, treated, or airlifted to a hospital. A story OUTSIDE Vermont/New England is relevant ONLY if it concerns the insurance/payer industry, health policy, or coverage. Another state's own Medicaid administration, marketplace premiums, rate filings, lawsuits, or a single employer's health plan outside New England is NOT relevant, even when it names national companies; keep it only when it involves a Blue Cross or Blue Shield plan or the Blue Cross Blue Shield Association, or federal or multi-state policy. National trend and policy stories of that kind qualify without naming Vermont. Individual out-of-region patient, crime, or human-interest stories, celebrity news, general science or finance, consumer how-to advice, and company, vendor, or law-firm promotions outside New England do not. When in doubt about a Vermont story, use true; when in doubt about a national story, use false.";
