...
export const INCLUSION_PRIORITIES = "They monitor news in priority order: (1) anything mentioning BCBSVT/Blue Cross, (2) Vermont health care broadly — hospitals, regulators, legislature, coverage, public health, even small local items that involve a Vermont or Vermont-serving provider, (3) New England health care, (4) national stories ONLY when about the health insurance/payer industry, health policy, or drug coverage. A single state's own program, market, or employer outside New England is not national.";
export const INCLUSION_RULES = "Geography matters: a Vermont story involving hospital operations, providers, coverage, regulators, access, public health, or costs is relevant. Crime, crash, and accident briefs are not relevant just because someone was taken, sent, treated, or airlifted to a hospital. A story OUTSIDE Vermont/New England is relevant ONLY if it concerns the insurance/payer industry, health policy, or coverage. Another state's own Medicaid administration, marketplace premiums, rate filings, or a single employer's health plan outside New England is NOT relevant; keep it only when it involves a Blue Cross or Blue Shield plan, a national insurer or industry trend, or federal or multi-state policy. When in doubt about a Vermont story, use true; when in doubt about a national story, use false.";
