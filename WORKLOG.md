...
**Follow-ups**: "Health Briefs - May 28, 2026" is absent from the merged archive despite surviving enrichment, merge and dedupe in isolation, and is the one genuine unexplained gap. The WCAX story on UVM Health cuts is present under a video URL with a truncated title rather than the tracker's URL. Scoring the ~153 newly eligible items will take about two hourly runs at the current summary cap.
